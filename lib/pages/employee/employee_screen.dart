...
class EmployeeScreen extends StatefulWidget {
  ...
  EmployeeScreen({super.key, required this.employee, required this.employeeId});
...
class _EmployeeScreenState extends State<EmployeeScreen> {
  ...
  CustomTextButton employeeBookingButton(BuildContext context) {
    return CustomTextButton(
        ...
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => BookingEmployeeScreen(
  ...
  Container employeeCommentsByRating() {
    return Container(
      height: 8.h,
